...
### 4.2 场景效果图
*(注：以下图片路径对应项目中生成的资源，需在本地运行并按 'S' 键获取)*

- **图1：布料覆盖球体**
  ![球体碰撞效果](assets/sphere_collision_demo.png)
  *描述：布料受到重力下落，被中间球体托住，形成自然的下垂弧度。*

- **图2：动态风场响应**
  ![风场效果](assets/wind_demo.png)
  *描述：在 2.0 强度风力下，布料末端产生剧烈的正弦波动。*
